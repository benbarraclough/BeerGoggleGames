...
cover: eleusis.webp
excerpt: >-
  Get rid of all your cards to win the game by placing the cards on the table in
  the correct position and conforming to Gods rules.
type: card
---
...
<GameHero
  cover="/BeerGoggleGames/images/eleusis.webp"
  alt="Eleusis"
/>
...
<p>Get rid of all your cards to win the game by placing the cards on the table in the correct position and conforming to Gods rules.</p>
</GameSection>
...
<GameSection title="**1D Eleusis**" icon="/BeerGoggleGames/images/question.webp">
<p>Instead of allowing the play of 2 dimensional cards, above, below, left and right. Only allow either left to right or above to below making it harder to place a correct card.</p>
</GameSection>
