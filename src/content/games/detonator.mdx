...
-   You can use any part of the head to impact the can.
-   A player can withdraw from the game if they obtain an injury.
</GameSection>

<GameSection title="Special Edition" icon="/images/special.webp">

<h4>Anything but hands</h4>

<p>Attempt to bust the can using your head but without the use of hands.</p>
</GameSection>
