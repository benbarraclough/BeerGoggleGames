...
<GameHero
  cover="/BeerGoggleGames/images/stein-run.webp"
  alt="Stein Run"
/>
...
<p>Finish all of your teams drinks quicker than any other team to win.</p>
</GameSection>
...
<GameSection title="**Flair**" icon="/BeerGoggleGames/images/question.webp">
<p>Add a bit of showmanship to the game to increase the difficulty and improve the experience for any members of the audience (e.g. spin before a catch or belly slide back from the end of the table)</p>
</GameSection>

<ShareButtons title="Stein Run" />
