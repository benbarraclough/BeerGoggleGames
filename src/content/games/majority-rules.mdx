...
cover: majority-rules.webp
excerpt: >-
  Guess the same as the king by showing a hand or a fist to prevent yourself
  from drinking and losing lives
type: misc
format: '1'
---
...
<GameHero
  cover="/BeerGoggleGames/images/majority-rules.webp"
  alt="Majority Rules"
/>
...
<p>Guess the same as the king by showing a hand or a fist to prevent yourself from drinking and losing lives</p>
</GameSection>
...
<GameSection title="**Modified rules**" icon="/BeerGoggleGames/images/question.webp">
...
<ShareButtons title="Majority Rules" />
